...
namespace BusinessLayer
{
    public class Order
    {
        ...
        public Order(string name, string email,string address, string phoneNumber,User user,List<OrderedProduct> products, PaymentMethod paymentMethod,decimal shippingCost)
        {
            ReceiverName = name;
            ReceiverEmail = email;
